...
for line in fhand:
    ...
    if re.compile("23\$81\$av\.\$i\(yr\.\),"):

        mfhd = line.split(", ")[0]

        p = re.compile("23\$81\$av\.\$i\(yr\.\),")
        matchResult = p.search(line)

        if "23$81$av.$i(yr.)," in str(matchResult):
            ...
            if matchResult:
                ...
                if re.search('[a-zA-Z>:]+', holdings):
                    ...
                    print ("Discard| " , mfhd, "|v.", m2, "(" , m3, ")", sep='')
                    ...
                    print ("Done| " , mfhd, "|v.", firstIssue, "(", firstDate, ")",
                           "-", "v.", secondIssue, "(", secondDate, ")", sep="")
