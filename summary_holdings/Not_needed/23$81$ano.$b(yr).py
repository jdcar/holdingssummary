...
fhand = open("H:\\MFHD\MFHDS_from_carli\\textfileprogram\\yearstests2.txt")

for line in fhand:

    if re.compile("23\$81\$ano\.\$b\(yr\)"):

        mfhd = line.split(", ")[0]

        p = re.compile("23\$81\$ano\.\$b\(yr\)")
        matchResult = p.search(line)

        if "23$81$ano.$b(yr)" in str(matchResult):
            ...
            if matchResult:
                ...
                if re.search('[a-zA-Z>]+', holdings):
                    ...
                    print ("Nope, " , mfhd, ", " ,"no.", m2, "(" , m3, ")", sep='')

                elif ("-" not in holdings):
                    
                    print ("Done, ", mfhd, ", " ,"no.", m2, "(" , m3, ")", sep='')
                    ...
                    print ("Done, " , mfhd, ", " "no.", firstIssue, "(", firstDate, ")", "-", "no.", secondIssue, "(", secondDate, ")", sep="")
